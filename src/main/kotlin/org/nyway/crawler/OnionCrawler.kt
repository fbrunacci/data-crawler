...
import org.nyway.es.data.PageIndexer
import org.nyway.tdif.Tfidf
...
class OnionCrawler : WebCrawler() {
    ...
    override fun visit(page: Page) {
        ...
        if (page.getParseData() is HtmlParseData) {
            ...
            PageIndexer.indexPage(org.nyway.es.data.Page(url,title,description,tags,page.getWebURL().domain))
        }
    }
